"""proyectoboard URL Configuration
...
urlpatterns = [
    ...
    # Password change
    url(r'^settings/password/$', views.PasswordChangeView.as_view(
        template_name='registration/password_change.html'), name='password_change'),
    url(r'^settings/password/done/$', views.PasswordChangeDoneView.as_view(
